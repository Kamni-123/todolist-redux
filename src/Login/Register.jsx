      ...
      <div className='mt-24 flex justify-center items-center'>
        <div className='max-w-md w-full mx-auto p-8 bg-transparent rounded-xl shadow-2xl'>
          ...
          <form className='mt-4' onSubmit={registerUser}>
            ...
            <button className='w-full px-4 py-2 mb-4 text-white bg-pink-500 rounded-lg hover:bg-blue-600 focus:outline-none focus:bg-blue-600' type="submit">Register</button>
